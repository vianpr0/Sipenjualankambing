<div class="bg-sky-950 sticky top-0 z-50">
    <div class="navbar  md:w-[70%] mx-auto md:pt-4 bgs-red-400">
        <div class="navbar-start bg-sblack">
            <div class="dropdown">
                <div id="menu-button" tabindex="0" role="button" class="btn btn-ghost lg:hidden"
                    ...
                    <svg id="icon-close"  class="h-5 w-5 hidden" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="navbar-center hidden bg-oransge-900 z-50  lg:flex text-white">
            <div class="dropdown">
                <div tabindex="0" role="button" class="btns m-1 flex items-center "> <svg class="w-6 h-6 text-white dark:text-white" aria-hidden="true"  width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 4h12M6 4v16M6 4H5m13 0v16m0-16h1m-1 16H6m12 0h1M6 20H5M9 7h1v1H9V7Zm5 0h1v1h-1V7Zm-5 4h1v1H9v-1Zm5 0h1v1h-1v-1Zm-3 4h2a1 1 0 0 1 1 1v4h-4v-4a1 1 0 0 1 1-1Z"/>
                </svg>Rilis Network</div>
                <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-sm shadow-green-700 text-wkhite bg-teal-200 rounded-t-sm w-52">
