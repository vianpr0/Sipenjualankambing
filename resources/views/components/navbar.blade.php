<div class="">
    <div class="navbar bg-sbase-100 md:w-[90%S] mx-auto md:pt-8">
        <div class="navbar-start">
            <div class="dropdown">
                <div id="menu-button" tabindex="0" role="button" class="btn btn-ghost lg:hidden" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation" onclick="toggleMenu()">
                    <svg id="icon-hamburger" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
   ...
   <div class="py-4 overflow-y-auto">
       <ul class="space-y-2 font-medium">
        ...
        <div class="navbar-end">
            ...
            <div class="flex relative rounded-md w-96 px-4 max-w-xl">
                <input type="text" name="q" id="query" placeholder="Cari berita"
