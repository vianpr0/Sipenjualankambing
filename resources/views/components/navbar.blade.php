<div class="">
    <div class="navbar bg-sbase-100 md:w-[90%S] mx-auto md:pt-8 bgs-red-400">
        ...
        <div class="navbar-center hidden bg-oransge-900 lg:flex text-black">
        ...
        <div class="navbar-end bg-blsack items-center justify-center pt-4 m-3s ">
